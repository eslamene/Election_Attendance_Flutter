...
abstract class AppLocalizations {
  ...
  /// **'Attending the General Assembly of the Court of Cassation'**
  String get appTitle;

  /// No description provided for @attendanceModes.
  ///
  /// In en, this message translates to:
  /// **'Attendance Modes'**
  String get attendanceModes;
  ...
  /// No description provided for @confirmUser.
  ///
  /// In en, this message translates to:
  /// **'Confirm User'**
  String get confirmUser;
  ...
  /// No description provided for @selectAttendanceMode.
  ///
  /// In en, this message translates to:
  /// **'Select Attendance Mode'**
  String get selectAttendanceMode;
  ...
  ///
  /// In en, this message translates to:
  /// **'API endpoint config here.'**
  String get apiEndpointConfig;

  /// No description provided for @scanError.
  ///
  /// In en, this message translates to:
  /// **'Scan failed or invalid code.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This user\'s attendance has already been recorded for this mode.'**
  ...
  /// No description provided for @saveApiEndpoint.
  ///
  /// In en, this message translates to:
  /// **'Save API Endpoint'**
  String get saveApiEndpoint;
